...
$(document).ready(function () {
    var app = new Vue({
        ...
        computed: {
            ...
            joukkueet: function(){
                if(this.uusi_raportti.miehet===CONST.RADIO_MIEHET) return CONST.MIEHET;
                if(this.uusi_raportti.miehet===CONST.RADIO_NAISET) return CONST.NAISET;
                return [];
            },
